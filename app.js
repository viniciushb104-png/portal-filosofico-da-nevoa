...
const achievementDefs=[
 ['first','Primeira Porta','🚪','Conclua qualquer sala.'],['perfect','Olhar de Coruja','🦉','Faça 30/30 em uma sala.'],['logic','Caçador de Falácias','🧠','Conclua a Sala da Lógica.'],['ethics','Juiz das Sombras','⚖️','Conclua o Tribunal das Sombras.'],['knowledge','Guardião do Espelho','🪞','Conclua Descartes e Platão.'],['explorer','Explorador da Mansão','🗺️','Conclua quatro salas.'],['socrates','Discípulo do Diálogo','🏛️','Conclua a Mansão de Sócrates.'],['platform','Caminhante de Atenas','🎮','Conclua O Labirinto dos Filósofos.'],['guardian','Guardião do Portal','🦇','Alcance 360 XP.']
];
